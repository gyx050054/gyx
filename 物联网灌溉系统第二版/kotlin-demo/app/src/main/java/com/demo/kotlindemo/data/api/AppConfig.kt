...
object AppConfig {
     ...
     *  - 墒情检测器：soilMoisture / soilTemperature
     *  - 电动阀：valveState / batteryLevel / instantFlow / totalWaterUsage / waterPressure / faultStatus
     */
    const val TELEMETRY_KEYS =
        "temperature,humidity,soilMoisture,soilTemperature,valveState,batteryLevel,instantFlow,totalWaterUsage,waterPressure,faultStatus"
}
